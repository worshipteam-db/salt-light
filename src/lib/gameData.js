...
export const EQUIPMENT = [
  ...
  { id: "devotee_rosary",    name: "Devotee Rosary",      type: "accessory",icon: "📿",  requiredLevel: 4,  xpCost: 0,    faithCost: 15,  costType: "faith", requiredJob: ["devotee","priest","paladin","prophet"], description: "Devotee exclusive",    passive: "+4 Faith per devotion" },
  ...
  { id: "holy_tome",         name: "Holy Tome",           type: "offhand",  icon: "📖",  requiredLevel: 14, xpCost: 0,    faithCost: 40,  costType: "faith", requiredJob: ["devotee","priest","paladin","prophet","scribe"], description: "For spiritual classes", passive: "+5 Faith on devotion completion" },
  ...
  { id: "pilgrim_robe",      name: "Pilgrim's Robe",      type: "armor",    icon: "👘",  requiredLevel: 17, xpCost: 0,    faithCost: 60,  costType: "faith", requiredJob: ["devotee","priest","paladin","prophet"], description: "Devotee classes only",  passive: "+8 Faith per devotion" },
  ...
  { id: "sanctuary_amulet",  name: "Sanctuary Amulet",    type: "accessory",icon: "📛",  requiredLevel: 30, xpCost: 300,  faithCost: 80,  costType: "both",  requiredJob: null,                          description: "Blessed protection",           passive: "+5 Faith on any goal complete" },
...
export const JOB_TREE = [
  ...
  { id: "priest",    name: "Priest",    icon: "✝️", requiredJob: "devotee", requiredLevel: 10, description: "Minister of growth. Faith flows freely.", bonuses: ["+10 Faith per devotion", "+5 XP on devotion"], tier: 2 },
  ...
  // Tier 4 (Lv 25–35)
  { id: "dark_knight", name: "Dark Knight", icon: "🖤", requiredJob: "knight", requiredLevel: 25, description: "Tempered by shadow and light.", bonuses: ["+25 XP on weekly & boss", "+20% XP all goals", "+2 SP per level"], tier: 4 },
  { id: "blood_mage",  name: "Blood Mage",  icon: "🩸", requiredJob: "berserker", requiredLevel: 25, description: "Power flows through sacrifice.", bonuses: ["+40 XP on boss fights", "+10% XP all goals", "+1 SP per level"], tier: 4 },
  ...
  // Tier 5 (Lv 35–70)
  { id: "shadow_lord",  name: "Shadow Lord",  icon: "👹", requiredJob: "dark_knight", requiredLevel: 35, description: "Lord of duality. Balance in extremes.", bonuses: ["+35 XP on boss fights", "+30% XP all goals", "+4 SP per level"], tier: 5 },
  { id: "blood_lord",   name: "Blood Lord",   icon: "🦇", requiredJob: "blood_mage", requiredLevel: 35, description: "Ultimate master of vital force.", bonuses: ["+50 XP on boss fights", "+20% XP all goals", "+2 SP per level"], tier: 5 },
  ...
  { id: "void_master",  name: "Void Master",  icon: "🌑", requiredJob: "shadow_lord", requiredLevel: 50, description: "Master of the void. Existence bends to will.", bonuses: ["+50 XP on boss fights", "+40% XP all goals", "+5 SP per level"], tier: 6 },
  { id: "crimson_king", name: "Crimson King", icon: "👑", requiredJob: "blood_lord", requiredLevel: 50, description: "Ultimate ruler of vital essence.", bonuses: ["+60 XP on boss fights", "+35% XP all goals", "+3 SP per level"], tier: 6 },
  { id: "cosmic_sage",  name: "Cosmic Sage",  icon: "🪐", requiredJob: "mystic", requiredLevel: 50, description: "Unified with the cosmic consciousness.", bonuses: ["+50 XP on long-term", "+40% XP all goals", "+7 SP per level"], tier: 6 },
